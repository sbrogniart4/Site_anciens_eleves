...
ECHO'<H1>MODIFICATION DE LA CATEGORIE 1 DU PIED DE PAGE</H1>';
echo'</div>';


	$bdd->exec("SET CHARACTER SET utf8");
	$requete=$bdd->query('SELECT nom_categorie,titre,texte FROM  categorie_piedpage1 WHERE id=1');
	...
	if(isset($_POST["updt1"]))
			...
			echo "<input type='submit' name='conf1' value='Confirmer' />";
							...
							if(isset($_POST["conf1"]))
							{
							 ...
							 $req = $bdd->prepare("UPDATE categorie_piedpage1 SET nom_categorie= :nom_categorie ");
						$req->execute(array(
			...
			echo "<input type='submit' name='conf2' value='Confirmer' />";
								...
								if(isset($_POST["conf2"]))
							{
							 ...
							 $req2 = $bdd->prepare("UPDATE categorie_piedpage1 SET titre= :titre ");
						$req2->execute(array(
				...
				if(isset($_POST["conf3"]))
							{
							 ...
							 $req3 = $bdd->prepare("UPDATE categorie_piedpage1 SET texte= :texte ");
						$req3->execute(array(
